            ...
            case 'ui':
                switch (name) {
                    ...
                    case 'pause':
                        return (
                            <G>
                                <Path d="M7,3H9a1,1,0,0,1,1,1V20a1,1,0,0,1-1,1H7a1,1,0,0,1-1-1V4A1,1,0,0,1,7,3Zm8,18h2a1,1,0,0,0,1-1V4a1,1,0,0,0-1-1H15a1,1,0,0,0-1,1V20A1,1,0,0,0,15,21Z"/>
                            </G>
                        );
                    case 'play':
                        return (
